...
- Developed an end-to-end data pipeline to process daily transactional sales data into clean, structured **customer** and **sales data marts**, enabling analytics-ready insights.
